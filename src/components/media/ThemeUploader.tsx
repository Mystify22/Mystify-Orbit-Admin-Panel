...
import { Palette, CheckCircle, RefreshCw, Eye, Sparkles, Image as ImageIcon, X } from 'lucide-react';
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              <div>
                ...
                <span style={{ fontSize: '0.8rem', color: 'var(--text-secondary)' }}>
                  {(selectedFile.size / (1024 * 1024)).toFixed(2)} MB • {selectedFile.type || 'Image/Vector'}
                </span>
              </div>
              <button
            ...
            <div style={{ display: 'flex', gap: '12px', marginTop: '16px' }}>
              ...
              >
                {status === 'uploading' ? (
                  ...
                  <>
                    <Sparkles size={18} /> Upload Theme Asset
                  </>
                )}
              </button>
